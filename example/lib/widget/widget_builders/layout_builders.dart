    ...
    for (var arg in argumentList) {
      if (arg.isNamedExpression) {
        ...
        switch (arg.asNamedExpression.label) {
          ...
          case 'appBar':
            appBar =
                FHWidgetBuilderFactory.buildWidgetWithExpression(expression, variables: {});
            break;
          case 'body':
            body = FHWidgetBuilderFactory.buildWidgetWithExpression(expression, variables: {});
            break;
      ...
      if (callee.asMemberExpression.property == 'builder') {
        return ListView.builder(
          itemBuilder: (context, index) {
            return FHWidgetBuilderFactory.buildWidgetWithExpression(
                itemBuilderExpression!, variables: {});
          },
          itemCount: itemCount,
        ...
        return ListView.separated(
          ...
          separatorBuilder: (context, index) {
            return FHWidgetBuilderFactory.buildWidgetWithExpression(
                separatorBuilderExpression!, variables: {});
          },
          padding: padding,
          shrinkWrap: shrinkWrap,
        );
